...
export default function BanheiroRaloForm() {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            // 1. Salvar no Supabase (chamados_banheiro)
            // Using chamados_banheiro as it's a bathroom service
            const { error } = await supabase.from("chamados_banheiro").insert({
                // protocolo: generated by trigger
                tenant_id: tenantId,
                localizacao: params.localizacao || "Local Desconhecido",

                // Specific mappings
                problema: "Ralo/Sifão (Terceirizado)",
                observacao: `[${values.nome_prestador}] Serviço: ${values.descricao_servico}. Obs: ${values.observacoes || '-'}`,

                status: "concluido", // It's a performed service record
                resolvido_por: null, // External
                criado_por: null // Public/QR
            });
